...
def close() { 
	...
	updateDeviceStatus("waiting")			// Now handled in the parent (in case we have an Acceleration sensor, we can handle "waiting" state)
...
def updateDeviceStatus(status) {	
    ...
    switch (status) {
        ...
        case "closed":
			...
			sendEvent(name: "acceleration", value: 'inactive', display: false, displayed: false)
            break
		...
		case "opening":
			if (currentState == "open"){
				...
				//sendEvent(name: "contact", value: "open", display: false, displayed: false /*, isStateChange: true*/)	// make sure we update the hidden states as well
				sendEvent(name: "acceleration", value: 'active', display: false, displayed: false)
        	}
            break
...
def updateDeviceAcceleration(value) {
	sendEvent(name: "acceleration", value: value, display: false, displayed: false)
}
